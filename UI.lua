...
function Luxt1.CreateWindow(libName, logoId)
    ...
    key1.Text = "LeftAlt"
    key1.TextColor3 = Color3.fromRGB(53, 196, 132)
    ...
    hubLogo.BackgroundColor3 = Color3.fromRGB(53, 196, 132)
    ...
    function TabHandling:Tab(tabText, tabId)
        ...
        tabBtn.Text = tabText
        tabBtn.TextColor3 = Color3.fromRGB(53, 196, 132)
        ...
        function sectionHandling:Section(sectionText)
            ...
            sectionName.TextColor3 = Color3.fromRGB(53, 196, 132)
            ...
            sectionExpannd.ImageColor3 = Color3.fromRGB(53, 196, 132)
            ...
            function ItemHandling:Button(btnText, callback)
                ...
                function ItemHandling:Toggle(toggInfo, callback)
                    ...
                    checkBtn.MouseButton1Click:Connect(function()
                        if not togDe then
                                ...
                                on = not on
                                 callback(on) 
                                if on then
                                    checkBtn.Parent.toggleInfo.TextColor3 = Color3.fromRGB(53, 196, 132)
                                    checkBtn.ImageColor3 = Color3.fromRGB(53, 196, 132)
                    ...
                    function ItemHandling:KeyBind(keyInfo, first, callback)
                        ...
                        key.Text = oldKey
                        key.TextColor3 = Color3.fromRGB(53, 196, 132)
                        key.TextSize = 14.000
                        ...
                        function ItemHandling:TextBox(infbix, textPlace, callback)
                            ...
                            TextBox.BackgroundColor3 = Color3.fromRGB(53, 196, 132)
                            ...
                            function ItemHandling:Slider(slidInfo, minvalue, maxvalue, callback)
                                ...
                                dragSlider.BackgroundColor3 = Color3.fromRGB(53, 196, 132)
                            ...
                            function ItemHandling:Credit(creditWho)
                                ...
                                function ItemHandling:DropDown(dropInfo, list, callback)
                                    ...
                                    expand_more.ImageColor3 = Color3.fromRGB(53, 196, 132)
                                    ...
                                    dropdownItem1.TextColor3 = Color3.fromRGB(53, 196, 132)
